...
import "./card-message-block.css";
import iconAI from "../../assets/icons/ai.svg";

function CardMessageBlock({title, content, prompt, onTitleChange, onContentChange, onPromptChange, regenerateContent, onDelete}) {
...
export default CardMessageBlock;